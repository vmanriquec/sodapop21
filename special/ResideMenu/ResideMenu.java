package com.food.sistemas.sodapopapp.special.ResideMenu;
...
public class ResideMenu extends FrameLayout {
    ...
    private void initViews(Context context, int customLeftMenuId,
        ...
        if (customLeftMenuId >= 0) {
            ...
            layoutLeftMenu = (LinearLayout) scrollViewLeftMenu.findViewById(com.special.ResideMenu.R.id.layout_left_menu);
        }
        ...
        if (customRightMenuId >= 0) {
            ...
            layoutRightMenu = (LinearLayout) scrollViewRightMenu.findViewById(com.special.ResideMenu.R.id.layout_right_menu);
        }

        imageViewShadow = (ImageView) findViewById(com.special.ResideMenu.R.id.iv_shadow);
        imageViewBackground = (ImageView) findViewById(com.special.ResideMenu.R.id.iv_background);
    ...
    public void setShadowVisible(boolean isVisible) {
        if (isVisible)
            imageViewShadow.setBackgroundResource(com.special.ResideMenu.R.drawable.shadow);
        else
